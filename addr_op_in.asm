...
;
; this file is not used directly to build imbNES.
; it used to be fed through some kind of custom macro processor to expand the
; address mode macros below into the full code you see in addr_op_out.asm
; the source code for that macro processor is long gone but there's nothing
; very complicated going on here...
;

; There are 154 valid opcodes (out of 256 total) on the NES.

;-------------------------------------------
; Addr mode and Instruction macros:
;
;@AM_INX_READ_BEGIN
;		addu	t8,t8,s1
;		andi	t8,t8,$FF
